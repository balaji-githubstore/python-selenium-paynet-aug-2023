...
#approach3  - js
# driver.execute_script("document.querySelector('#bill-date-long').value='20/12/2000'")

web_element=driver.find_element(By.XPATH,"//input[@id='bill-date-long']")
driver.execute_script("arguments[0].value='20/12/2000'",web_element)
